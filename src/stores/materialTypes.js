...
const getMaterialTypesData = (data) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ payload: 'Error Fetching Material Types', type: 'Feedback' })
        return err
    }
...
const addMaterialTypesData = (data) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ payload: 'Error Adding Material Types', type: 'Feedback' })
        return err
    }
}
...
const deleteMaterialTypesData = (data) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ payload: 'Error Deleting Material Types', type: 'Feedback' })
        return err
    }
}
